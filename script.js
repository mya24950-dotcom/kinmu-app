...
let scheduleFixedHeaderWrapper = null;
let scheduleFixedHeaderTableOriginal = null;
let scheduleFixedHeaderFrame = null;
let scheduleFixedHeaderBound = false;
...
function setupScheduleFixedHeader() {
  ...
  */
  ...
  cloneTable.style.background =
    "#ffffff";

  cloneTable.style.position =
    "relative";
  ...
  */
  ...
  scheduleFixedHeaderWrapper =
    wrapper;

  scheduleFixedHeaderTableOriginal =
    table;
  ...
  */
  ...
  if (!scheduleFixedHeaderBound) {

    window.addEventListener(
      "scroll",
      scheduleFixedHeaderUpdate,
      {
        passive: true
      }
    );
...
function removeScheduleFixedHeader() {
  ...
  scheduleFixedHeaderWrapper = null;

  scheduleFixedHeaderTableOriginal = null;


  if (scheduleFixedHeaderFrame) {

    cancelAnimationFrame(
      scheduleFixedHeaderFrame
    );

    scheduleFixedHeaderFrame = null;
...
function scheduleFixedHeaderUpdate() {
  ...
  scheduleFixedHeaderFrame =
    requestAnimationFrame(() => {
      ...
      updateScheduleFixedHeaderPosition();
...
function updateScheduleFixedHeaderPosition() {
  ...
  */
  ...
  syncScheduleFixedHeaderColumns(
    table,
    cloneTable
  );
...
function syncScheduleFixedHeaderColumns(
  originalTable,
  cloneTable
) {
  ...
  const cloneHead =
    cloneTable.querySelector("thead");
  ...
  const originalRows =
    originalHead.querySelectorAll("tr");

  const cloneRows =
    cloneHead.querySelectorAll("tr");
  ...
  for (
    ...
    for (
      ...
      if (
        ...
        cloneCell.style.minWidth =
          width + "px";

        cloneCell.style.maxWidth =
          width + "px";
